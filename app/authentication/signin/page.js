          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border rounded-md focus:outline-none text-black focus:ring-2 focus:ring-blue-400"
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border rounded-md focus:outline-none text-black focus:ring-2 focus:ring-blue-400"
                style={{ borderColor: '#463A93' }}
              />
